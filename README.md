...
*   **Dokumentasi API:** Untuk penjelasan detail tentang setiap kelas dan metode, silakan kunjungi [Dokumentasi API kami](https://github.com/deft-orchestrator/p5.videoeditor.js/deployments/github-pages) (Tautan ini akan aktif setelah GitHub Pages diatur).
